    ...
    <div class="container">
        ...
        <div class="d-flex flex-wrap justify-content-around align-items-center mt-5 mb-4 wrap-md-4">
            @foreach($data as $gels)
                <div class="card h-100 mb-4" style="width: 19rem;" data-id="{{$gels['id']}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center">
                            <a href="{{ url('catalog/faces') }}/{{ $gels['id'] }}" class="btn btn-dark border-2 m-1" style="font-size: 14px">Подробнее</a>
                            <div class="m-1">
