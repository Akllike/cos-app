...
@extends('header')
@section('title', 'Гели - Добавить гель | ShaR')
@section('content')
    <div class="container mt-5" style="max-width: 600px">
        <form action="gels/add" method="POST" class="row g-3 needs-validation">
            @csrf
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="image" value="storage/img/" class="form-control" id="basic-url" aria-describedby="basic-addon3 basic-addon4">
                </div>
