                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <form action="{{ route('cart.add') }}" method="post" class="m-1">
                            ...
                            <button onclick="addToCart({{ $item['id'] }})" type="button" class="btn btn-outline-dark border-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="font-size: 14px">
                                В корзину
